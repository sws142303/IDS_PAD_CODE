package com.azkj.chw.coreprogress.listener.impl.handler;
...
public abstract class ProgressHandler extends Handler {
        ...
        switch (msg.what) {
            case UPDATE: {
                ...
                if (uiProgessListener != null) {
                    ...
                    //回调抽象方法
                    progress(uiProgessListener, progressModel.getFilename(),progressModel.getCurrentBytes(), progressModel.getContentLength(), progressModel.isDone());
                }
                break;
            }
            case START: {
            ...
            case FINISH: {
                ...
                if (uiProgressListener != null) {
                    ...
                    ProgressModel progressModel = (ProgressModel) msg.obj;
                    //回调抽象方法
                    finish(uiProgressListener, progressModel.getFilename(),progressModel.getCurrentBytes(), progressModel.getContentLength(), progressModel.isDone());
                }
                break;
            }
            default:
    ...
    public abstract void progress(UIProgressListener uiProgressListener,String filename,long currentBytes, long contentLength, boolean done);
    public abstract void finish(UIProgressListener uiProgressListener,String filename,long currentBytes, long contentLength, boolean done);
}
