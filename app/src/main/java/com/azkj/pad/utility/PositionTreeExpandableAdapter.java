...
/*定位系统用户可展开列表适配器*/
public class PositionTreeExpandableAdapter extends BaseExpandableListAdapter {
	private Context context;
	private LayoutInflater layoutInflater;
	private List<GroupInfo> groupInfos;
	
	@SuppressWarnings("static-access")
	public PositionTreeExpandableAdapter(Context context) {
		this.context = context;
		this.layoutInflater=layoutInflater.from(context);
	}
	@SuppressWarnings("static-access")
	public PositionTreeExpandableAdapter(Context context, List<GroupInfo> groupInfos) {
		this.context = context;
		this.layoutInflater=layoutInflater.from(context);
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (memberinfo.isInmeeting()){
			addorcut.setImageDrawable(convertView.getResources().getDrawable(R.drawable.location_status));
		}
		else {
			/*addorcut.setImageDrawable(convertView.getResources().getDrawable(R.drawable.location_status));*/
		}
