...
public interface IPullToRefresh<T extends View> {
	...
	abstract void setMode(PullToRefreshBase.Mode mode);
	...
	abstract void setOnRefreshListener(PullToRefreshBase.OnRefreshListener<T> listener);

	abstract void setOnRefreshListener(PullToRefreshBase.OnRefreshListener2<T> listener);
